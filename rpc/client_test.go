...
func TestClientSubscribeInvalidArg(t *testing.T) {
	...
	check := func(shouldPanic bool, arg any) {
		...
		client.ParallaxSubscribe(context.Background(), arg, "foo_bar")
	}
	check(true, nil)
	check(true, 1)
...
// This test reproduces https://github.com/ParallaxProtocol/parallax/issues/17837 where the
...
// It is the reproducer for https://github.com/ParallaxProtocol/parallax/issues/22322
