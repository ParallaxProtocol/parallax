...
// Contains a wrapper for the Parallax client.
...
type ParallaxClient struct {
	client *prlclient.Client
}

// NewParallaxClient connects a client to the given URL.
func NewParallaxClient(rawurl string) (client *ParallaxClient, _ error) {
	rawClient, err := prlclient.Dial(rawurl)
	return &ParallaxClient{rawClient}, err
}

// GetBlockByHash returns the given full block.
func (ec *ParallaxClient) GetBlockByHash(ctx *Context, hash *Hash) (block *Block, _ error) {
...
func (ec *ParallaxClient) GetBlockByNumber(ctx *Context, number int64) (block *Block, _ error) {
	if number < 0 {
...
func (ec *ParallaxClient) GetHeaderByHash(ctx *Context, hash *Hash) (header *Header, _ error) {
...
func (ec *ParallaxClient) GetHeaderByNumber(ctx *Context, number int64) (header *Header, _ error) {
	if number < 0 {
...
func (ec *ParallaxClient) GetTransactionByHash(ctx *Context, hash *Hash) (tx *Transaction, _ error) {
...
func (ec *ParallaxClient) GetTransactionSender(ctx *Context, tx *Transaction, blockhash *Hash, index int) (sender *Address, _ error) {
...
func (ec *ParallaxClient) GetTransactionCount(ctx *Context, hash *Hash) (count int, _ error) {
...
func (ec *ParallaxClient) GetTransactionInBlock(ctx *Context, hash *Hash, index int) (tx *Transaction, _ error) {
...
func (ec *ParallaxClient) GetTransactionReceipt(ctx *Context, hash *Hash) (receipt *Receipt, _ error) {
...
func (ec *ParallaxClient) SyncProgress(ctx *Context) (progress *SyncProgress, _ error) {
...
func (ec *ParallaxClient) SubscribeNewHead(ctx *Context, handler NewHeadHandler, buffer int) (sub *Subscription, _ error) {
...
func (ec *ParallaxClient) GetBalanceAt(ctx *Context, account *Address, number int64) (balance *BigInt, _ error) {
	if number < 0 {
...
func (ec *ParallaxClient) GetStorageAt(ctx *Context, account *Address, key *Hash, number int64) (storage []byte, _ error) {
	if number < 0 {
...
func (ec *ParallaxClient) GetCodeAt(ctx *Context, account *Address, number int64) (code []byte, _ error) {
	if number < 0 {
...
func (ec *ParallaxClient) GetNonceAt(ctx *Context, account *Address, number int64) (nonce int64, _ error) {
	if number < 0 {
...
func (ec *ParallaxClient) FilterLogs(ctx *Context, query *FilterQuery) (logs *Logs, _ error) {
...
func (ec *ParallaxClient) SubscribeFilterLogs(ctx *Context, query *FilterQuery, handler FilterLogsHandler, buffer int) (sub *Subscription, _ error) {
	// Subscribe to the event internally
...
func (ec *ParallaxClient) GetPendingBalanceAt(ctx *Context, account *Address) (balance *BigInt, _ error) {
...
func (ec *ParallaxClient) GetPendingStorageAt(ctx *Context, account *Address, key *Hash) (storage []byte, _ error) {
...
func (ec *ParallaxClient) GetPendingCodeAt(ctx *Context, account *Address) (code []byte, _ error) {
...
func (ec *ParallaxClient) GetPendingNonceAt(ctx *Context, account *Address) (nonce int64, _ error) {
...
func (ec *ParallaxClient) GetPendingTransactionCount(ctx *Context) (count int, _ error) {
...
func (ec *ParallaxClient) CallContract(ctx *Context, msg *CallMsg, number int64) (output []byte, _ error) {
	if number < 0 {
...
func (ec *ParallaxClient) SuggestGasPrice(ctx *Context) (price *BigInt, _ error) {
...
func (ec *ParallaxClient) EstimateGas(ctx *Context, msg *CallMsg) (gas int64, _ error) {
...
func (ec *ParallaxClient) SendTransaction(ctx *Context, tx *Transaction) error {
