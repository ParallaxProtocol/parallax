...
// Package graphql provides a GraphQL interface to Parallax node data.
package graphql
...
// Block represents an Parallax block.
...
type CallData struct {
	From                 *common.Address // The Parallax address the call is from.
	To                   *common.Address // The Parallax address the call is to.
...
type SyncState struct {
	progress parallax.SyncProgress
}
