...
// information related to the Parallax protocol such als blocks, transactions and logs.
...
func (api *PublicFilterAPI) Logs(ctx context.Context, crit FilterCriteria) (*rpc.Subscription, error) {
	...
	logsSub, err := api.events.SubscribeLogs(parallax.FilterQuery(crit), matchedLogs)
	if err != nil {
		return nil, err
	}
...
// Same as parallax.FilterQuery but with UnmarshalJSON() method.
type FilterCriteria parallax.FilterQuery
