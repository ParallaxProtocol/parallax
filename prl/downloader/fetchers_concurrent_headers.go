...
func (q *headerQueue) request(peer *peerConnection, req *fetchRequest, resCh chan *prl.Response) (*prl.Request, error) {
...
func (q *headerQueue) deliver(peer *peerConnection, packet *prl.Response) (int, error) {
	headers := *packet.Res.(*prl.BlockHeadersPacket)
