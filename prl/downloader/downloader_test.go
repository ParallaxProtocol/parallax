...
func (dlp *downloadTesterPeer) RequestHeadersByHash(origin common.Hash, amount int, skip int, reverse bool, sink chan *prl.Response) (*prl.Request, error) {
	// Service the header query via the live handler code
	rlpHeaders := prl.ServiceGetBlockHeadersQuery(dlp.chain, &prl.GetBlockHeadersPacket{
...
// origin; associated with a particular peer in the download tester. The returned
// function can be used to retrieve batches of headers from the particular peer.
func (dlp *downloadTesterPeer) RequestHeadersByNumber(origin uint64, amount int, skip int, reverse bool, sink chan *prl.Response) (*prl.Request, error) {
	// Service the header query via the live handler code
	rlpHeaders := prl.ServiceGetBlockHeadersQuery(dlp.chain, &prl.GetBlockHeadersPacket{
		Origin: prl.HashOrNumber{
			Number: origin,
...
func (dlp *downloadTesterPeer) RequestBodies(hashes []common.Hash, sink chan *prl.Response) (*prl.Request, error) {
...
func (dlp *downloadTesterPeer) RequestReceipts(hashes []common.Hash, sink chan *prl.Response) (*prl.Request, error) {
	blobs := prl.ServiceGetReceiptsQuery(dlp.chain, hashes)
	...
	res := &prl.Response{
		Req:  req,
		Res:  (*prl.ReceiptsPacket)(&receipts),
		Meta: hashes,
		Time: 1,
		Done: make(chan error, 1), // Ignore the returned status
	}
...
func TestCanonicalSynchronisation66Full(t *testing.T)  { testCanonSync(t, prl.Parallax66, FullSync) }
func TestCanonicalSynchronisation66Snap(t *testing.T)  { testCanonSync(t, prl.Parallax66, SnapSync) }
func TestCanonicalSynchronisation66Light(t *testing.T) { testCanonSync(t, prl.Parallax66, LightSync) }
...
func TestThrottling66Full(t *testing.T) { testThrottling(t, prl.Parallax66, FullSync) }
func TestThrottling66Snap(t *testing.T) { testThrottling(t, prl.Parallax66, SnapSync) }
...
func TestForkedSync66Full(t *testing.T)  { testForkedSync(t, prl.Parallax66, FullSync) }
func TestForkedSync66Snap(t *testing.T)  { testForkedSync(t, prl.Parallax66, SnapSync) }
func TestForkedSync66Light(t *testing.T) { testForkedSync(t, prl.Parallax66, LightSync) }
...
func TestHeavyForkedSync66Snap(t *testing.T) { testHeavyForkedSync(t, prl.Parallax66, SnapSync) }
...
// long dead chains.
func TestBoundedForkedSync66Full(t *testing.T)  { testBoundedForkedSync(t, prl.Parallax66, FullSync) }
func TestBoundedForkedSync66Snap(t *testing.T)  { testBoundedForkedSync(t, prl.Parallax66, SnapSync) }
func TestBoundedForkedSync66Light(t *testing.T) { testBoundedForkedSync(t, prl.Parallax66, LightSync) }
...
func TestBoundedHeavyForkedSync66Full(t *testing.T) {
	testBoundedHeavyForkedSync(t, prl.Parallax66, FullSync)
}

func TestBoundedHeavyForkedSync66Snap(t *testing.T) {
	testBoundedHeavyForkedSync(t, prl.Parallax66, SnapSync)
}

func TestBoundedHeavyForkedSync66Light(t *testing.T) {
	testBoundedHeavyForkedSync(t, prl.Parallax66, LightSync)
}
...
func TestCancel66Full(t *testing.T)  { testCancel(t, prl.Parallax66, FullSync) }
func TestCancel66Snap(t *testing.T)  { testCancel(t, prl.Parallax66, SnapSync) }
func TestCancel66Light(t *testing.T) { testCancel(t, prl.Parallax66, LightSync) }
...
func TestMultiSynchronisation66Full(t *testing.T) {
	testMultiSynchronisation(t, prl.Parallax66, FullSync)
}

func TestMultiSynchronisation66Snap(t *testing.T) {
	testMultiSynchronisation(t, prl.Parallax66, SnapSync)
}

func TestMultiSynchronisation66Light(t *testing.T) {
	testMultiSynchronisation(t, prl.Parallax66, LightSync)
}
...
func TestMultiProtoSynchronisation66Full(t *testing.T) {
	testMultiProtoSync(t, prl.Parallax66, FullSync)
}

func TestMultiProtoSynchronisation66Snap(t *testing.T) {
	testMultiProtoSync(t, prl.Parallax66, SnapSync)
}

func TestMultiProtoSynchronisation66Light(t *testing.T) {
	testMultiProtoSync(t, prl.Parallax66, LightSync)
}
...
func testMultiProtoSync(t *testing.T, protocol uint, mode SyncMode) {
	...
	tester.newPeer("peer 66", prl.Parallax66, chain.blocks[1:])
	// tester.newPeer("peer 65", parallax.ETH67, chain.blocks[1:)
...
func TestEmptyShortCircuit66Full(t *testing.T)  { testEmptyShortCircuit(t, prl.Parallax66, FullSync) }
func TestEmptyShortCircuit66Snap(t *testing.T)  { testEmptyShortCircuit(t, prl.Parallax66, SnapSync) }
func TestEmptyShortCircuit66Light(t *testing.T) { testEmptyShortCircuit(t, prl.Parallax66, LightSync) }
...
func TestMissingHeaderAttack66Full(t *testing.T) {
	testMissingHeaderAttack(t, prl.Parallax66, FullSync)
}

func TestMissingHeaderAttack66Snap(t *testing.T) {
	testMissingHeaderAttack(t, prl.Parallax66, SnapSync)
}

func TestMissingHeaderAttack66Light(t *testing.T) {
	testMissingHeaderAttack(t, prl.Parallax66, LightSync)
}
...
func TestShiftedHeaderAttack66Full(t *testing.T) {
	testShiftedHeaderAttack(t, prl.Parallax66, FullSync)
}

func TestShiftedHeaderAttack66Snap(t *testing.T) {
	testShiftedHeaderAttack(t, prl.Parallax66, SnapSync)
}

func TestShiftedHeaderAttack66Light(t *testing.T) {
	testShiftedHeaderAttack(t, prl.Parallax66, LightSync)
}
...
func TestInvalidHeaderRollback66Snap(t *testing.T) {
	testInvalidHeaderRollback(t, prl.Parallax66, SnapSync)
}
...
func TestHighTDStarvationAttack66Full(t *testing.T) {
	testHighTDStarvationAttack(t, prl.Parallax66, FullSync)
}

func TestHighTDStarvationAttack66Snap(t *testing.T) {
	testHighTDStarvationAttack(t, prl.Parallax66, SnapSync)
}

func TestHighTDStarvationAttack66Light(t *testing.T) {
	testHighTDStarvationAttack(t, prl.Parallax66, LightSync)
}
...
func TestBlockHeaderAttackerDropping66(t *testing.T) {
	testBlockHeaderAttackerDropping(t, prl.Parallax66)
}
...
func TestSyncProgress66Full(t *testing.T)  { testSyncProgress(t, prl.Parallax66, FullSync) }
func TestSyncProgress66Snap(t *testing.T)  { testSyncProgress(t, prl.Parallax66, SnapSync) }
func TestSyncProgress66Light(t *testing.T) { testSyncProgress(t, prl.Parallax66, LightSync) }
...
func testSyncProgress(t *testing.T, protocol uint, mode SyncMode) {
	...
	checkProgress(t, tester.downloader, "pristine", parallax.SyncProgress{})
	...
	<-starting
	checkProgress(t, tester.downloader, "initial", parallax.SyncProgress{
	...
	<-starting
	checkProgress(t, tester.downloader, "completing", parallax.SyncProgress{
	...
	progress <- struct{}{}
	pending.Wait()
	checkProgress(t, tester.downloader, "final", parallax.SyncProgress{
		StartingBlock: uint64(len(chain.blocks)/2 - 1),
...
func checkProgress(t *testing.T, d *Downloader, stage string, want parallax.SyncProgress) {
	// Mark this method as a helper to report errors at callsite, not in here
	t.Helper()
...
// revertal).
func TestForkedSyncProgress66Full(t *testing.T) { testForkedSyncProgress(t, prl.Parallax66, FullSync) }
func TestForkedSyncProgress66Snap(t *testing.T) { testForkedSyncProgress(t, prl.Parallax66, SnapSync) }
func TestForkedSyncProgress66Light(t *testing.T) {
	testForkedSyncProgress(t, prl.Parallax66, LightSync)
}
...
func testForkedSyncProgress(t *testing.T, protocol uint, mode SyncMode) {
	...
	<-starting
	checkProgress(t, tester.downloader, "forking", parallax.SyncProgress{
...
func TestFailedSyncProgress66Full(t *testing.T) { testFailedSyncProgress(t, prl.Parallax66, FullSync) }
func TestFailedSyncProgress66Snap(t *testing.T) { testFailedSyncProgress(t, prl.Parallax66, SnapSync) }
func TestFailedSyncProgress66Light(t *testing.T) {
	testFailedSyncProgress(t, prl.Parallax66, LightSync)
}
...
func TestFakedSyncProgress66Full(t *testing.T)  { testFakedSyncProgress(t, prl.Parallax66, FullSync) }
func TestFakedSyncProgress66Snap(t *testing.T)  { testFakedSyncProgress(t, prl.Parallax66, SnapSync) }
func TestFakedSyncProgress66Light(t *testing.T) { testFakedSyncProgress(t, prl.Parallax66, LightSync) }
...
func TestCheckpointEnforcement66Full(t *testing.T) {
	testCheckpointEnforcement(t, prl.Parallax66, FullSync)
}

func TestCheckpointEnforcement66Snap(t *testing.T) {
	testCheckpointEnforcement(t, prl.Parallax66, SnapSync)
}

func TestCheckpointEnforcement66Light(t *testing.T) {
	testCheckpointEnforcement(t, prl.Parallax66, LightSync)
}
