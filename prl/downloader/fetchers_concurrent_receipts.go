...
func (q *receiptQueue) request(peer *peerConnection, req *fetchRequest, resCh chan *prl.Response) (*prl.Request, error) {
...
func (q *receiptQueue) deliver(peer *peerConnection, packet *prl.Response) (int, error) {
	receipts := *packet.Res.(*prl.ReceiptsPacket)
