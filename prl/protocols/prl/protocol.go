...
// ProtocolName is the official short name of the `parallax` protocol used during
// devp2p capability negotiation.
const ProtocolName = "parallax"

// ProtocolVersions are the supported versions of the `parallax` protocol (first
// is primary).
var ProtocolVersions = []uint{Parallax66}

// protocolLengths are the number of implemented message corresponding to
// different protocol versions.
var protocolLengths = map[uint]uint64{Parallax66: 17}
...
// StatusPacket is the network packet for the status message for parallax/64 and later.
...
// GetBlockHeadersPacket66 represents a block header query over parallax/66
...
// BlockHeadersPacket66 represents a block header response over parallax/66.
...
// BlockHeadersRLPPacket66 represents a block header response over parallax/66.
...
// GetBlockBodiesPacket66 represents a block body query over parallax/66.
...
// BlockBodiesPacket66 is the network packet for block content distribution over parallax/66.
...
// BlockBodiesRLPPacket66 is the BlockBodiesRLPPacket over parallax/66
...
// GetNodeDataPacket66 represents a trie node data query over parallax/66.
...
// NodeDataPacket66 is the network packet for trie node data distribution over parallax/66.
...
// GetReceiptsPacket66 represents a block receipts query over parallax/66.
...
// ReceiptsPacket66 is the network packet for block receipts distribution over parallax/66.
...
// ReceiptsRLPPacket66 is the parallax-66 version of ReceiptsRLPPacket
...
// PooledTransactionsPacket66 is the network packet for transaction distribution over parallax/66.
...
// PooledTransactionsRLPPacket66 is the parallax/66 form of PooledTransactionsRLPPacket
