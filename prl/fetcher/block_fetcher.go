...
type headerRequesterFn func(common.Hash, chan *prl.Response) (*prl.Request, error)

// bodyRequesterFn is a callback type for sending a body retrieval request.
type bodyRequesterFn func([]common.Hash, chan *prl.Response) (*prl.Request, error)
...
type BlockFetcher struct {
	...
	fetchingHook       func([]common.Hash)               // Method to call upon starting a block (parallax/61) or header (parallax/62) fetch
	completingHook     func([]common.Hash)               // Method to call upon starting a block body fetch (parallax/62)
	importedHook       func(*types.Header, *types.Block) // Method to call upon successful header or block import (both parallax/61 and parallax/62)
}
