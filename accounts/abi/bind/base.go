...
type TransactOpts struct {
	From   common.Address // Parallax account to send the transaction from
...
type BoundContract struct {
	address    common.Address     // Deployment address of the contract on the Parallax blockchain
	abi        abi.ABI            // Reflect based ABI to access the correct Parallax methods
