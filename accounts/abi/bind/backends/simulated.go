...
type SimulatedBackend struct {
	database   prldb.Database   // In memory database to store our testing data
	blockchain *core.BlockChain // Parallax blockchain to handle the consensus
...
func (fb *filterBackend) ChainDb() prldb.Database  { return fb.db }
