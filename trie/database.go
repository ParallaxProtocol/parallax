...
type Database struct {
	diskdb prldb.KeyValueStore // Persistent storage for matured trie nodes
...
func NewDatabase(diskdb prldb.KeyValueStore) *Database {
...
func NewDatabaseWithConfig(diskdb prldb.KeyValueStore, config *Config) *Database {
...
func (db *Database) DiskDB() prldb.KeyValueStore {
	return db.diskdb
}
...
func (db *Database) commit(hash common.Hash, batch prldb.Batch, uncacher *cleaner, callback func(common.Hash)) error {
