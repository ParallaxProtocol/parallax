...
type NodeIterator interface {
	...
	AddResolver(prldb.KeyValueReader)
}
...
type nodeIterator struct {
	...
	resolver prldb.KeyValueReader // Optional intermediate resolver above the disk layer
}
...
func (it *nodeIterator) AddResolver(resolver prldb.KeyValueReader) {
...
func (it *differenceIterator) AddResolver(resolver prldb.KeyValueReader) {
...
func (it *unionIterator) AddResolver(resolver prldb.KeyValueReader) {
	panic("not implemented")
}
