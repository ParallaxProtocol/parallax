...
func (req *TrieRequest) StoreResult(db prldb.Database) {
	req.Proof.Store(db)
}
...
// StoreResult stores the retrieved data in local database
func (req *CodeRequest) StoreResult(db prldb.Database) {
...
// StoreResult stores the retrieved data in local database
func (req *BlockRequest) StoreResult(db prldb.Database) {
...
// StoreResult stores the retrieved data in local database
func (req *ReceiptsRequest) StoreResult(db prldb.Database) {
	if !req.Untrusted {
...
// StoreResult stores the retrieved data in local database
func (req *ChtRequest) StoreResult(db prldb.Database) {
...
// StoreResult stores the retrieved data in local database
func (req *BloomRequest) StoreResult(db prldb.Database) {
...
// StoreResult stores the retrieved data in local database
func (req *TxStatusRequest) StoreResult(db prldb.Database) {}
