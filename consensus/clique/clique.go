...
// ecrecover extracts the Parallax account address from a signed header.
func ecrecover(header *types.Header, sigcache *lru.ARCCache) (common.Address, error) {
	...
	// Recover the public key and the Parallax address
...
// Parallax testnet following the testnet attacks.
type Clique struct {
	config *params.CliqueConfig // Consensus engine configuration parameters
	db     prldb.Database       // Database to store and retrieve snapshot checkpoints
	...
	signer common.Address // Parallax address of the signing key
...
func New(config *params.CliqueConfig, db prldb.Database) *Clique {
...
// Author implements consensus.Engine, returning the Parallax address recovered
