...
// mapped from textual names used in the tests below to actual Parallax private
...
// address retrieves the Parallax address of a tester account by label, creating
...
func (ap *testerAccountPool) address(account string) common.Address {
	...
	// Resolve and return the Parallax address
...
func TestClique(t *testing.T) {
	...
	tests := []struct {
	...
	}{
		{
			...
			// batch (https://github.com/ParallaxProtocol/parallax/issues/17593). Whilst this
