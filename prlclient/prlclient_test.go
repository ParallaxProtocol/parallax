...
var (
	...
	_ = parallax.ChainStateReader(&Client{})
	_ = parallax.ChainSyncReader(&Client{})
	_ = parallax.ContractCaller(&Client{})
	_ = parallax.GasEstimator(&Client{})
...
func testChainID(t *testing.T, client *rpc.Client) {
	...
	if id == nil || id.Cmp(params.AllXHashProtocolChanges.ChainID) != 0 {
