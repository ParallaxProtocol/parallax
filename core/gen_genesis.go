...
func (g Genesis) MarshalJSON() ([]byte, error) {
	type Genesis struct {
		...
		EpochStartTime math.HexOrDecimal64                         `json:"epochStartTime"`
	...
	enc.EpochStartTime = math.HexOrDecimal64(g.EpochStartTime)
...
func (g *Genesis) UnmarshalJSON(input []byte) error {
	...
	if dec.EpochStartTime != nil {
		g.EpochStartTime = uint64(*dec.EpochStartTime)
	}
