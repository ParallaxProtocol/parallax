...
// Package state provides a caching layer atop the Parallax state trie.
package state
...
func (s *StateDB) Copy() *StateDB {
	...
	for addr := range s.journal.dirties {
		// As documented [here](https://github.com/ParallaxProtocol/parallax/pull/16485#issuecomment-380438527),
