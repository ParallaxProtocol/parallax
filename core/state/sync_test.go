...
// account array.
func checkStateAccounts(t *testing.T, db prldb.Database, root common.Hash, accounts []*testAccount) {
...
func checkTrieConsistency(db prldb.Database, root common.Hash) error {
...
func checkStateConsistency(db prldb.Database, root common.Hash) error {
...
func TestIncompleteStateSync(t *testing.T) {
	...
	checkTrieConsistency(srcDb.TrieDB().DiskDB().(prldb.Database), srcRoot)
