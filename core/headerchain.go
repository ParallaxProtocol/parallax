...
func NewHeaderChain(chainDb prldb.Database, config *params.ChainConfig, engine consensus.Engine, procInterrupt func() bool) (*HeaderChain, error) {
...
type (
	...
	UpdateHeadBlocksCallback func(prldb.KeyValueWriter, *types.Header) (uint64, bool)

	// DeleteBlockContentCallback is a callback function that is called by SetHead
	// before each header is deleted.
	DeleteBlockContentCallback func(prldb.KeyValueWriter, common.Hash, uint64)
)
