...
// It returns the PVM's return value, the new state and an error if it failed.
//
...
// Create executes the code using the PVM create method
...
// PVM's return value or an error if it failed.
//
