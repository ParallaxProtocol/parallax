...
// Package asm provides support for dealing with PVM assembly instructions (e.g., disassembling them).
package asm
...
// PrintDisassembled pretty-print all disassembled PVM instructions to stdout.
...
// Disassemble returns all disassembled PVM instructions in human-readable format.
