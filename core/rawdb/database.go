...
func (db *nofreezedb) ModifyAncients(func(prldb.AncientWriteOp) error) (int64, error) {
	return 0, errNotSupported
}
...
func (db *nofreezedb) ReadAncients(fn func(reader prldb.AncientReaderOp) error) (err error) {
...
func NewDatabase(db prldb.KeyValueStore) prldb.Database {
...
// storage.
func NewDatabaseWithFreezer(db prldb.KeyValueStore, freezer string, namespace string, readonly bool) (prldb.Database, error) {
...
func NewMemoryDatabase() prldb.Database {
...
func NewMemoryDatabaseWithCap(size int) prldb.Database {
	return NewDatabase(memorydb.NewWithCap(size))
}

// NewLevelDBDatabase creates a persistent key-value database without a freezer
// moving immutable chain segments into cold storage.
func NewLevelDBDatabase(file string, cache int, handles int, namespace string, readonly bool) (prldb.Database, error) {
...
// freezer moving immutable chain segments into cold storage.
func NewLevelDBDatabaseWithFreezer(file string, cache int, handles int, freezer string, namespace string, readonly bool) (prldb.Database, error) {
...
func InspectDatabase(db prldb.Database, keyPrefix, keyStart []byte) error {
