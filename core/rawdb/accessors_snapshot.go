...
func ReadSnapshotDisabled(db prldb.KeyValueReader) bool {
	disabled, _ := db.Has(snapshotDisabledKey)
	return disabled
}

// WriteSnapshotDisabled stores the snapshot pause flag.
func WriteSnapshotDisabled(db prldb.KeyValueWriter) {
...
func DeleteSnapshotDisabled(db prldb.KeyValueWriter) {
...
func ReadSnapshotRoot(db prldb.KeyValueReader) common.Hash {
...
// the persisted snapshot.
func WriteSnapshotRoot(db prldb.KeyValueWriter, root common.Hash) {
...
// invalid.
func DeleteSnapshotRoot(db prldb.KeyValueWriter) {
...
func ReadAccountSnapshot(db prldb.KeyValueReader, hash common.Hash) []byte {
	data, _ := db.Get(accountSnapshotKey(hash))
	return data
}

// WriteAccountSnapshot stores the snapshot entry of an account trie leaf.
func WriteAccountSnapshot(db prldb.KeyValueWriter, hash common.Hash, entry []byte) {
...
func DeleteAccountSnapshot(db prldb.KeyValueWriter, hash common.Hash) {
...
func ReadStorageSnapshot(db prldb.KeyValueReader, accountHash, storageHash common.Hash) []byte {
	data, _ := db.Get(storageSnapshotKey(accountHash, storageHash))
	return data
}

// WriteStorageSnapshot stores the snapshot entry of an storage trie leaf.
func WriteStorageSnapshot(db prldb.KeyValueWriter, accountHash, storageHash common.Hash, entry []byte) {
...
func DeleteStorageSnapshot(db prldb.KeyValueWriter, accountHash, storageHash common.Hash) {
...
func IterateStorageSnapshots(db prldb.Iteratee, accountHash common.Hash) prldb.Iterator {
...
func ReadSnapshotJournal(db prldb.KeyValueReader) []byte {
...
func WriteSnapshotJournal(db prldb.KeyValueWriter, journal []byte) {
...
// the last shutdown
func DeleteSnapshotJournal(db prldb.KeyValueWriter) {
...
// the last shutdown.
func ReadSnapshotGenerator(db prldb.KeyValueReader) []byte {
...
// shutdown.
func WriteSnapshotGenerator(db prldb.KeyValueWriter, generator []byte) {
...
// the last shutdown
func DeleteSnapshotGenerator(db prldb.KeyValueWriter) {
...
// snapshot layer.
func ReadSnapshotRecoveryNumber(db prldb.KeyValueReader) *uint64 {
...
// snapshot layer.
func WriteSnapshotRecoveryNumber(db prldb.KeyValueWriter, number uint64) {
	var buf [8]byte
...
// snapshot layer.
func DeleteSnapshotRecoveryNumber(db prldb.KeyValueWriter) {
...
func ReadSnapshotSyncStatus(db prldb.KeyValueReader) []byte {
	data, _ := db.Get(snapshotSyncStatusKey)
	return data
}

// WriteSnapshotSyncStatus stores the serialized sync status to save at shutdown.
func WriteSnapshotSyncStatus(db prldb.KeyValueWriter, status []byte) {
