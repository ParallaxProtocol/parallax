...
func NewTable(db prldb.Database, prefix string) prldb.Database {
	return &table{
		db:     db,
		prefix: prefix,
	}
...
func (t *table) ModifyAncients(fn func(prldb.AncientWriteOp) error) (int64, error) {
	return t.db.ModifyAncients(fn)
}

func (t *table) ReadAncients(fn func(reader prldb.AncientReaderOp) error) (err error) {
...
func (t *table) NewIterator(prefix []byte, start []byte) prldb.Iterator {
...
func (t *table) NewBatch() prldb.Batch {
	return &tableBatch{t.db.NewBatch(), t.prefix}
}

// NewBatchWithSize creates a write-only database batch with pre-allocated buffer.
func (t *table) NewBatchWithSize(size int) prldb.Batch {
...
func (t *table) NewSnapshot() (prldb.Snapshot, error) {
...
func (b *tableBatch) Replay(w prldb.KeyValueWriter) error {
