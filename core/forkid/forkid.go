...
// NewID calculates the Parallax fork ID from the chain config, genesis hash, and head.
...
// NewIDWithChain calculates the Parallax fork ID from an existing chain instance.
