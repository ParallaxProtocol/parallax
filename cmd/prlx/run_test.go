...
func init() {
	// Run the app if we've been exec'd as "prlx-test" in runPrlx.
	reexec.Register("prlx-test", func() {
...
// spawns prlx with the given command line args. If the args don't set --datadir, the
// child g gets a temporary data directory.
func runPrlx(t *testing.T, args ...string) *testprlx {
	tt := &testprlx{}
