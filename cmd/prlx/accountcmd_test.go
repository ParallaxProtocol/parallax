...
func TestAccountListEmpty(t *testing.T) {
	geth := runPrlx(t, "account", "list")
	geth.ExpectExit()
}

func TestAccountList(t *testing.T) {
	datadir := tmpDatadirWithKeystore(t)
	geth := runPrlx(t, "account", "list", "--datadir", datadir)
...
func TestAccountNew(t *testing.T) {
	geth := runPrlx(t, "account", "new", "--lightkdf")
	defer geth.ExpectExit()
	geth.Expect(`
...
func importAccountWithExpect(t *testing.T, key string, expected string) {
	...
	geth := runPrlx(t, "--lightkdf", "account", "import", keyfile, "-password", passwordFile)
	defer geth.ExpectExit()
...
func TestWalletImport(t *testing.T) {
	geth := runPrlx(t, "wallet", "import", "--lightkdf", "testdata/guswallet.json")
	defer geth.ExpectExit()
	geth.Expect(`
!! Unsupported terminal, password will be echoed.
