...
// pvm executes PVM code snippets.
package main
...
var (
	app = flags.NewApp(gitCommit, gitDate, "the pvm command line interface")
	...
	CodeFileFlag = cli.StringFlag{
		Name:  "codefile",
		Usage: "File containing PVM code. If '-' is specified, code is read from stdin ",
	}
	GasFlag = cli.Uint64Flag{
		Name:  "gas",
		Usage: "gas limit for the pvm",
		Value: 10000000000,
	}
	PriceFlag = utils.BigFlag{
		Name:  "price",
		Usage: "price set for the pvm",
		Value: new(big.Int),
	}
	ValueFlag = utils.BigFlag{
		Name:  "value",
		Usage: "value set for the pvm",
		Value: new(big.Int),
	}
	...
	InputFlag = cli.StringFlag{
		Name:  "input",
		Usage: "input for the PVM",
	}
	InputFileFlag = cli.StringFlag{
		Name:  "inputfile",
		Usage: "file containing input for the PVM",
	}
