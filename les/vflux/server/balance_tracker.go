...
func newBalanceTracker(ns *nodestate.NodeStateMachine, setup *serverSetup, db prldb.KeyValueStore, clock mclock.Clock, posExp, negExp utils.ValueExpirer) *balanceTracker {
