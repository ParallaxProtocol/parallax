...
// PrivateLightServerAPI provides an API to access the LPS light server.
type PrivateLightServerAPI struct {
	server                               *LesServer
	defaultPosFactors, defaultNegFactors vfs.PriceFactors
}

// NewPrivateLightServerAPI creates a new LPS light server API.
...
// PrivateDebugAPI provides an API to debug LPS light server functionality.
type PrivateDebugAPI struct {
	server *LesServer
}

// NewPrivateDebugAPI creates a new LPS light server debug API.
...
// PrivateLightAPI provides an API to access the LPS light server or light client.
type PrivateLightAPI struct {
	backend *lesCommons
}

// NewPrivateLightAPI creates a new LPS service API.
