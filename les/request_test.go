...
type accessTestFn func(db prldb.Database, bhash common.Hash, number uint64) light.OdrRequest
...
func tfBlockAccess(db prldb.Database, bhash common.Hash, number uint64) light.OdrRequest {
...
func tfReceiptsAccess(db prldb.Database, bhash common.Hash, number uint64) light.OdrRequest {
...
func tfTrieEntryAccess(db prldb.Database, bhash common.Hash, number uint64) light.OdrRequest {
...
func tfCodeAccess(db prldb.Database, bhash common.Hash, num uint64) light.OdrRequest {
