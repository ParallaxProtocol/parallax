...
// deliver is called by the LPS protocol manager to deliver reply messages to waiting requests
...
// frozen is called by the LPS protocol manager when a server has suspended its service and we
