...
type downloadTester struct {
	...
	stateDb prldb.Database // Database used by the tester for syncing from peers
	peerDb  prldb.Database // Database of the peers containing all data
...
func TestCanonicalSynchronisation66Fast(t *testing.T)  { testCanonSync(t, prl.Parallax66, FastSync) }
...
func TestThrottling66Fast(t *testing.T) { testThrottling(t, prl.Parallax66, FastSync) }
...
func TestForkedSync66Fast(t *testing.T)  { testForkedSync(t, prl.Parallax66, FastSync) }
...
func TestHeavyForkedSync66Full(t *testing.T)  { testHeavyForkedSync(t, prl.Parallax66, FullSync) }
func TestHeavyForkedSync66Fast(t *testing.T)  { testHeavyForkedSync(t, prl.Parallax66, FastSync) }
func TestHeavyForkedSync66Light(t *testing.T) { testHeavyForkedSync(t, prl.Parallax66, LightSync) }
...
func TestBoundedForkedSync66Fast(t *testing.T)  { testBoundedForkedSync(t, prl.Parallax66, FastSync) }
...
func TestBoundedHeavyForkedSync66Fast(t *testing.T) {
	testBoundedHeavyForkedSync(t, prl.Parallax66, FastSync)
}
...
func TestCancel66Fast(t *testing.T)  { testCancel(t, prl.Parallax66, FastSync) }
...
func TestMultiSynchronisation66Fast(t *testing.T) {
	testMultiSynchronisation(t, prl.Parallax66, FastSync)
}
...
func TestMultiProtoSynchronisation66Fast(t *testing.T) {
	testMultiProtoSync(t, prl.Parallax66, FastSync)
}
...
func testMultiProtoSync(t *testing.T, protocol uint, mode SyncMode) {
	...
	tester.newPeer("peer 66", prl.Parallax66, chain)
	// tester.newPeer("peer 65", prl.ETH67, chain)
...
func TestEmptyShortCircuit66Fast(t *testing.T)  { testEmptyShortCircuit(t, prl.Parallax66, FastSync) }
...
func TestMissingHeaderAttack66Fast(t *testing.T) {
	testMissingHeaderAttack(t, prl.Parallax66, FastSync)
}
...
func TestShiftedHeaderAttack66Fast(t *testing.T) {
	testShiftedHeaderAttack(t, prl.Parallax66, FastSync)
}
...
func TestInvalidHeaderRollback66Fast(t *testing.T) {
	testInvalidHeaderRollback(t, prl.Parallax66, FastSync)
}
...
func TestHighTDStarvationAttack66Fast(t *testing.T) {
	testHighTDStarvationAttack(t, prl.Parallax66, FastSync)
}
...
func TestSyncProgress66Fast(t *testing.T)  { testSyncProgress(t, prl.Parallax66, FastSync) }
...
func TestForkedSyncProgress66Fast(t *testing.T) { testForkedSyncProgress(t, prl.Parallax66, FastSync) }
...
func TestFailedSyncProgress66Fast(t *testing.T) { testFailedSyncProgress(t, prl.Parallax66, FastSync) }
...
func TestFakedSyncProgress66Fast(t *testing.T)  { testFakedSyncProgress(t, prl.Parallax66, FastSync) }
...
func TestDeliverHeadersHang66Full(t *testing.T) { testDeliverHeadersHang(t, prl.Parallax66, FullSync) }
func TestDeliverHeadersHang66Fast(t *testing.T) { testDeliverHeadersHang(t, prl.Parallax66, FastSync) }
func TestDeliverHeadersHang66Light(t *testing.T) {
	testDeliverHeadersHang(t, prl.Parallax66, LightSync)
}
...
func TestCheckpointEnforcement66Fast(t *testing.T) {
	testCheckpointEnforcement(t, prl.Parallax66, FastSync)
}
