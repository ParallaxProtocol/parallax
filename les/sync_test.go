...
func TestMissOracleBackendLPS3(t *testing.T)             { testMissOracleBackend(t, true, lpv3) }
func TestMissOracleBackendNoCheckpointLPS3(t *testing.T) { testMissOracleBackend(t, false, lpv3) }
...
func testMissOracleBackend(t *testing.T, hasCheckpoint bool, protocol int) {
	...
	//
	// See https://github.com/ParallaxProtocol/parallax/issues/20097 for more detail.
	//
...
func TestSyncFromConfiguredCheckpointLPS3(t *testing.T) { testSyncFromConfiguredCheckpoint(t, lpv3) }
