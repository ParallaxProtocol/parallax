...
// reqMapping maps an LPS request to one or two vflux service vector entries.
...
var (
	// requests describes the available LPS request types and their initializing amounts
